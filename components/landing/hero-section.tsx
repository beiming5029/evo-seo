    ...
    <section className="relative h-screen min-h-[800px] flex items-center justify-center overflow-hidden">
      ...
      <Container className="relative z-10 text-center px-4">
        ...
        >
          ...
          >
            <Button size="lg" className="rounded-full px-8 py-6 text-lg bg-slate-900 dark:bg-blue-600 hover:bg-slate-800 dark:hover:bg-blue-500 text-white shadow-lg hover:shadow-xl transition-all hover:-translate-y-1" as="a" href="/#contact">
              立即咨询
